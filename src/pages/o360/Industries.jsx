...
import { Container, MonoLabel, Pending, Reveal, Section, Button } from '../../components/ui';
...
/** Traced India outline (Natural Earth geometry) with red blinking markers on metro cities. */
    ...
    <>
              ...
              <table className="w-full min-w-[640px] border-collapse text-left">
                ...
                <tbody>
                  {INDUSTRIES.map((industry) => {
                    ...
                    return (
                      <tr key={industry.slug} className="border-b border-ink-14 align-top">
      ...
      <Section surface="ink" ambient>
        <Container>
          ...
          <Reveal className="mt-14 grid gap-px overflow-hidden rounded-lg bg-paper-14 sm:grid-cols-2 lg:grid-cols-4" delay={60}>
            {['Vendors onboarded', 'Clients onboarded', 'PMs onboarded', 'Projects running'].map((stat) => (
              <div key={stat} className="flex min-h-[9rem] flex-col justify-between gap-6 bg-ink p-6">
